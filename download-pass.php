...
<html lang="en">
<head>
<title>gestion flotte soumafe || chauffeur Page</title>
	...
	<div class="agileits-banner">
		<div class="bnr-agileinfo"> 
			...
			<div class="banner-text agileinfo about-bnrtext"> 
				<div class="container">
					<h2><a href="index.php">Home</a> / View chauffeur</h2> 
				</div>
			</div>
			<!-- //banner-text -->   
		</div>
...
$sdata=$_POST['searchdata'];
  ...
  <h4 style="padding-bottom: 20px;">Result against "<?php echo $sdata;?>" keyword </h4>
                                <table border="2" class="table table-bordered" style="font-size: 18px;">
                                    ...
                                    <tbody>
                                        <?php
$sql="SELECT * from chauffeur_list where telephone1 like '$sdata%'";
...
{               ?>
                  ...
                  <td><a href="view-pass-detail.php?viewid=<?php echo htmlentities ($row->chID);?>" class="btn btn-primary">View </a></td>
                </tr>
               <?php 
$cnt=$cnt+1;
} } else { ?>
