 <div class="sidebar-menu">
    <header class="logo">
        <a href="#" class="sidebar-icon"> <span class="fa fa-bars"></span> </a> <a href="dashboard.php"> <span id="logo"> <h1></h1></span> 
...
{               ?>
    ...
    <div class="menu">
        <ul id="menu" >
            ...
            <li><a href="add-client.php"><i class="fa fa-user"></i> <span></span></a></li>
            <li><a href="manage-client.php"><i class="fa fa-table"></i> <span></span></a></li>
            <li><a href="invoices.php"><i class="fa fa-file-text-o"></i> <span></span></a></li>

            <li id="menu-academico" ><a href="#"><i class="fa fa-table"></i> <span> </span> <span class="fa fa-angle-right" style="float: right"></span></a>
                <ul id="menu-academico-sub" >
            ...
            <li><a href="search-invoices.php"><i class="fa fa-search"></i> <span>Search</span></a></li>
