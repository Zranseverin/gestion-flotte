       ...
       <?php include_once('includes/header.php');?>
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                 <!--  page header -->
                <div class="col-lg-12">
                    <h1 class="page-header">vtotal</h1>
                </div>
                 <!-- end  page header -->
            </div>
            <div class="row">
...
{               ?>
                  ...
                  <td><?php  echo htmlentities($row->total_v);?></td>
                  <td><?php  echo htmlentities($row->total_r);?></td>
                  <td><?php  echo htmlentities($row->total_p);?></td>
