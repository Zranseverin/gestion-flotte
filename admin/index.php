...
<head>
    ...
    <title>Gestion flotte soumafe | Login Page</title>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-4 col-md-offset-4 text-center logo-margin ">
              <h3 style="color: white;">Systeme de gestion flotte vtc soumafe</h3>
                </div>
...
<label style="padding-left: 40px">
    <a href="forgot-password.php">Mot de passe oublié?</a></label>
                                </div>
                    ...
                    <p> Si vous n'avez pas de compte! <a href="inscr-user.php"> creer </a></p>
                </div>
                <div>
                    <i class="fa fa-home" style="font-size: 30px" aria-hidden="true"></i>
