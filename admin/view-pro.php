        ...
        <!--  page-wrapper -->
          <div id="page-wrapper">
            <div class="row">
                 <!-- page header -->
                <div class="col-lg-12">
                    <h1 class="page-header">detail  proprietaire</h1>
                </div>
                <!--end page header -->
            </div>
            <div class="row">
                        ...
                        <div class="panel-body">
                            <div class="row" id="divToPrint">
                                <div class="col-lg-12">
                                   <?php
$vid=$_GET['viewid'];
$sql="SELECT * from  pr_list where ID=$vid";
...
<input type="button" value="print" onclick="PrintDiv();" /></p>
                                    ...
                                    <tr>
    <th scope>Photo</th>
    <td colspan="3"><img src="images/<?php  echo ($row->photo);?>" width="50" height="50"></td>
...
<tr>
  ...
  <tr>
    ...
    <td colspan="3"><?php  echo ($row->dteN);?></td>
...
<tr>
    <th scope>numero de compte</th>
    <td><?php  echo ($row->ncpt);?></td>
    <th scope>cni</th>
...
<tr>
  ...
  <tr>
    ...
    <th scope> Date d'enregistrement</th>
