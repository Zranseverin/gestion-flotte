...
$query-> execute();
     ...
     if($query -> rowCount() == 0)
{
$sql="update tblcategory set marque=:marque where ID=:eid";
...
<head>
    ...
    <title>gestion des flottes  | Update Marque</title>
        ...
        <!--  page-wrapper -->
          <div id="page-wrapper">
            <div class="row">
                 <!-- page header -->
                <div class="col-lg-12">
                    <h1 class="page-header">Update marque</h1>
                </div>
                <!--end page header -->
            </div>
            <div class="row">
...
{               ?>
    ...
    <div class="form-group"> <label for="exampleInputEmail1">marque</label> <input type="text" name="marque" value="<?php  echo $row->marque;?>" class="form-control" required='true'> </div>
