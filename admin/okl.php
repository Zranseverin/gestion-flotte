                                        ...
                                        if ($query->rowCount() > 0) {
                                            foreach ($results as $row) { ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="view-pannes.php?id_declaration=<?php echo htmlentities($row->id_declaration); ?>" class="btn btn-info btn-sm">Voir les détails</a>
                                                    </td>
                                                </tr>
                                        <?php
                                                $cnt++;
...
define('DB_USER','if0_36929431');
define('DB_PASS','1jXAvqyyPpm');
define('DB_NAME','if0_36929431_flotte03');
