...
$photo=md5($photo).time().$extension;
 move_uploaded_file($_FILES["photo"]["tmp_name"],"images/".$photo);
    ...
    $query= "update vh_list set photo=:photo where ID=:eid";
...
{               ?>
                   <div class="form-group"> <label for="exampleInputEmail1">immatriculation</label> <input type="text" name="imt" value="<?php  echo $row->imt;?>" class="form-control" readonly='true'> </div>                 
    <div class="form-group"> <label for="exampleInputEmail1"> Photo</label> <img src="images/<?php echo $row->photo;?>" width="500" height="500" value="<?php  echo $row->photo;?>"> </div>
