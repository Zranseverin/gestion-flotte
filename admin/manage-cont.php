...
if (strlen($_SESSION['bpmsaid']==0)) {
  header('location:logout.php');
        ...
        $sql="delete from cnt_list where cntID=:rid";
...
{               ?>
                  ...
                  <td><?php  echo htmlentities($row->renum);?></td>
                  <td><?php  echo htmlentities($row->dure);?></td>
                  <td><?php  echo htmlentities($row->tm);?></td>
